...
import { generateNumericRe } from "../../../../utils";
                    ...
                    <form onSubmit={handleSubmit} className="flex flex-col gap-2"  >
                        ...
                        <div>
                            ...
                            <Space.Compact style={{ width: '100%' }}>
                                ...
                                <Button size="large" variant="solid" color="pink" onClick={() => setFieldValue("reference_no", generateNumericRe())}><RedoOutlined /></Button>
                            </Space.Compact>
